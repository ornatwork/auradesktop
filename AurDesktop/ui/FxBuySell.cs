...
{
    public partial class FxBuySell : Form
    {
        ...
        public FxBuySell(ExAction pxAction, string psSymbol, string psPlayerName, int piShares, double pdPrice ) 
        {
            InitializeComponent();
            ...
            //
            this.cmbAction.Text = pxAction.ToString();
            this.cmbStocks.Text = psSymbol + ", " + psPlayerName;

            //
            this.txPrice.Text = pdPrice.ToString();

            // Always adjustable by the user
            this.txShares.Text = piShares.ToString();
        }
        ...
        private void init( string psStock, string psPlayerName  )
        {
            ...
            this.cmbStocks.DataSource = mlStocks;
        ...
        private void btSave_Click(object sender, EventArgs e)
        {
          ...
          /*
            double dPrice = CxUtil.getDouble(this.txPrice.Text);
            ...
            if( this.txPrice.Text == string.Empty || dPrice == 0 )
            {
            ...
            string success = CxDeskUtil.trade(this.cmbStocks.Text.Substring(0, 4), this.cmbAction.Text,
                                                    CxUtil.getInt(this.txShares.Text), dPrice);
